  ...
  return (
    <div ref={rootRef} style={{ position: "relative" }}>
      ...
      >
        ...
        <Calendar
          size={13}
          style={{ color: open ? "var(--brand)" : "var(--text-tertiary)", flexShrink: 0, transition: "color var(--dur-fast) var(--ease-out)" }}
        />
      </button>
            ...
            {Array.from({ length: total }, (_, i) => {
              ...
              return (
                <button key={day} type="button" className={cls} disabled={isOff}
                  ...
                  style={{ color: isSel ? undefined : isOff ? "var(--text-tertiary)" : "var(--text-primary)", fontWeight: isToday && !isSel ? 600 : undefined }}>
                  {day}
                </button>
              );
            })}
